...
const Render = {
  ...
  init: function () {
    this.current_room = WORLD.createRoom('hall', 'img/room.png')
    this.my_user = new User('img/user.png', 'unnamed')
    this.current_room.addUser(this.my_user)
    this.current_room.addUser(new User('img/spritesheet.png', 'otherUser'))
  },
  ...
  onMouse: function (e) {
    ...
    } else if (e.type == 'mousemove') {}  // mouseup
    else {}
  },
}
